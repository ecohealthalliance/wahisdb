...
#' @return
#' @export
add_wahis_outbreak_data_raw_to_db <- function(wahis_outbreak_data_raw, db_branch) {

  if(is.null(wahis_outbreak_data_raw)) return(NULL) # This target expects a report containing the hash
  ...
  dbAddData(conn,
            ...
            value = wahis_outbreak_data_raw$outbreak_reports_ingest_status_log,
  ...
  outbreak_reports_diseases_unmatched <- wahis_outbreak_data_raw$outbreak_reports_diseases_unmatched
