...
create_six_month_tables <- function(six_month_status_extract,
  ...
  six_month_tables$wahis_six_month_quantitative <- six_month_tables$wahis_six_month_quantitative |>
    mutate(six_month_quantitative_unique_id = paste(year, semester_code, country, disease, serotype_subtype_genotype, animal_category, species, event_id, outbreak_id, administrative_division, sep = "_")) |>
