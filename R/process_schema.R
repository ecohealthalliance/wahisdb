...
#' @export
process_schema <- function(schema_extract, outbreak_events_tables_standardized, six_month_tables_standardized, disease_key, taxon_key) {
  ...
  wahis_epi_events_schema <- tibble(table = "wahis_epi_events",
                                    field = colnames(outbreak_events_tables_standardized$wahis_epi_events),
                                    field_type = map_chr(outbreak_events_tables_standardized$wahis_epi_events, ~class(.)[1])) |>
  ...
  wahis_outbreaks_schema <- tibble(table = "wahis_outbreaks",
                                   field = colnames(outbreak_events_tables_standardized$wahis_outbreaks),
                                   field_type = map_chr(outbreak_events_tables_standardized$wahis_outbreaks, ~class(.)[1])) |>
    left_join(schema_extract) |>
  ...
  wahis_six_month_status_schema <- tibble(table = "wahis_six_month_status",
                                          field = colnames(six_month_tables_standardized$wahis_six_month_status),
                                          field_type = map_chr(six_month_tables_standardized$wahis_six_month_status, ~class(.)[1])) |>
  ...
  wahis_six_month_controls_schema <- tibble(table = "wahis_six_month_controls",
                                            field = colnames(six_month_tables_standardized$wahis_six_month_controls),
                                            field_type = map_chr(six_month_tables_standardized$wahis_six_month_controls, ~class(.)[1])) |>
    left_join(schema_extract) |> # not much overlap
  ...
  wahis_six_month_quantitative_schema <- tibble(table = "wahis_six_month_quantitative",
                                                field = colnames(six_month_tables_standardized$wahis_six_month_quantitative),
                                                field_type = map_chr(six_month_tables_standardized$wahis_six_month_quantitative, ~class(.)[1])) |>
    left_join(schema_extract) |> # not much overlap
